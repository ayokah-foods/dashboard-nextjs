        ...
        <div className="p-0 space-y-2">
            ...
            <div className="mt-8 border-t border-gray-200 pt-5">
                <div className="flex justify-end space-x-3">
                    <button
                        onClick={handleSave}
                        className="bg-ayokah-secondary inline-flex items-center cursor-pointer justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white hover:bg-ayokah-secondary"
                    >
                        Save {type}
                    </button>
                </div>
