...
export default function Notifications() {
    ...
    const [notificationStats, setNotificationStats] = useState<
        NotificationResponse["stats"] | null
    >(null);
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <Popover className="relative inline-block">
                            ...
                            >
                                <PopoverPanel className="absolute z-10 mt-0 w-80 max-w-[20rem] p-4 bg-white border border-gray-200 rounded-md shadow-lg text-sm text-gray-800 break-words whitespace-pre-wrap">
                                    {body}
                                </PopoverPanel>
                            </Transition>
                        </Popover>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500">
                        Manage your notification overview here.
                    </p>
                </div>
                ...
                <div className="flex gap-3 items-center">
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-xl bg-ayokah-primary text-white hover:bg-ayokah-secondary"
                    >
