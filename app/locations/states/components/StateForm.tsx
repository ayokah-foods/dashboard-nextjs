...
import { storeState, listCountries } from '@/app/api_/locations';
                ...
                <SelectDropdown
                    ...
                    value={
                        form.country_id
                            ? {
                                label:
                                    countries.find((c) => c.id === Number(form.country_id))?.name ||
                                    "Select Country",
                    ...
                    onChange={(selected) =>
                        setForm((prev) => ({ ...prev, country_id: Number(selected.value) }))
                    }
                    className="w-full"
                />
            </div>
