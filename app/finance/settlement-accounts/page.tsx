...
} from "@/types/SettlementAccountType";
...
export default function SettlementAccounts() {
    ...
    const fetchSettlementAccounts = useCallback(
        async (pageIndex: number, searchTerm: string) => {
            setLoading(true);
            setError(null);
            try {
                const response: SettlementAccountType =
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500">
                        Manage your settlement accounts here.
                    </p>
                </div>
                ...
                <div className="w-78">
                    <input
                        ...
                        className="mb-4 w-full max-w-sm text-gray-800 px-3 py-2 border rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-ayokah-secondary"
                    />
                </div>
            </div>
